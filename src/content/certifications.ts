...
export const certifications: Certification[] = [
  ...
  // pertinents pour un poste numérique).
  {
    ...
    credentialId: 'gcbgh6ftw2o4',
    url: 'https://verify.skilljar.com/c/gcbgh6ftw2o4',
    skills: [
  ...
  },
  {
    ...
    credentialId: 'v8ezpsmo7ure',
    url: 'https://verify.skilljar.com/c/v8ezpsmo7ure',
    skills: [
  ...
  {
    id: 'claude-101',
    name: { fr: 'Claude 101', en: 'Claude 101' },
    issuer: 'Anthropic',
    date: '2026-07-23',
    dateLabel: { fr: 'Juillet 2026', en: 'July 2026' },
    image: '/certifications/claude-101.jpg',
    credentialId: '7j7n3gtqxwqc',
    url: 'https://verify.skilljar.com/c/7j7n3gtqxwqc',
    skills: [
      { fr: 'Fondamentaux de Claude', en: 'Claude fundamentals' },
      { fr: 'Usage raisonné d’un assistant IA', en: 'Effective use of an AI assistant' },
    ],
  },
  {
    id: 'ai-fluency-builders',
    name: { fr: 'AI Fluency for Builders', en: 'AI Fluency for Builders' },
    issuer: 'CodePath.org · Anthropic',
    date: '2026-07-28',
    dateLabel: { fr: 'Juillet 2026', en: 'July 2026' },
    image: '/certifications/ai-fluency-builders.jpg',
    credentialId: 'fze3f82q6jx2',
    url: 'https://verify.skilljar.com/c/fze3f82q6jx2',
    skills: [
      { fr: 'Concevoir avec l’IA générative', en: 'Building with generative AI' },
      { fr: 'Pratiques d’usage pour créateurs', en: 'Practices for builders' },
    ],
  },
  {
    id: 'ai-fluency-small-business',
    name: { fr: 'AI Fluency for Small Businesses', en: 'AI Fluency for Small Businesses' },
    issuer: 'PayPal · Anthropic',
    date: '2026-07-28',
    dateLabel: { fr: 'Juillet 2026', en: 'July 2026' },
    image: '/certifications/ai-fluency-small-business.jpg',
    credentialId: 'pwc4bc6maw87',
    url: 'https://verify.skilljar.com/c/pwc4bc6maw87',
    skills: [
      { fr: 'IA appliquée aux petites structures', en: 'AI applied to small businesses' },
      { fr: 'Cas d’usage et gains opérationnels', en: 'Use cases & operational gains' },
    ],
  },
  {
    id: 'lvmh',
    ...
    // Identifiant repris du lien de vérification fourni par Florian (17/08/2026).
    // Un autre identifiant circulait dans les notes de préparation
    // (fcaee30a-d1c0-4e50-a633-10090dd905e6) : c'est celui du lien qui fait foi,
    // puisque c'est lui qui permet de contrôler la certification.
    credentialId: '9b3d338c-0440-4231-ae1a-d0420d05907c',
    url: 'https://www.insidelvmh.com/certificate/9b3d338c-0440-4231-ae1a-d0420d05907c',
    skills: [
